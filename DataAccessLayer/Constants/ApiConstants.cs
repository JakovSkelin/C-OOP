...
namespace DataAccessLayer.Constants
{
    public static class ApiConstants
    {
        ...
        public const string FemaleMatchesWebLocation = "https://worldcup-vua.nullbit.hr/women/matches";
        public const string FemaleDetailedMatchesWebLocation = "https://worldcup-vua.nullbit.hr/women/matches/country?fifa_code=ENG";

        public const string MaleTeamsWebLocation = "https://worldcup-vua.nullbit.hr/men/matches";
